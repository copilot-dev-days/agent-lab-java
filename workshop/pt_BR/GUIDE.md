...
[🎮 Demo ao Vivo](https://copilot-dev-days.github.io/agent-lab-java/) • [📚 Guia do Lab](https://copilot-dev-days.github.io/agent-lab-java/docs/) • [← README](../README.md)
...
| [**01**](01-setup.md) | Configuração & Engenharia de Contexto | 15 min |
| [**02**](02-design.md) | Frontend Design-First | 15 min |
| [**03**](03-quiz-master.md) | Quiz Master Personalizado | 10 min |
| [**04**](04-multi-agent.md) | Desenvolvimento Multi-Agente | 20 min |
...
```
# 1. Use o template em github.com/copilot-dev-days/agent-lab-java
# 2. Ative o GitHub Pages (Settings > Pages > GitHub Actions)
# 3. Clone no VS Code
...
- [ ] Revisar instruções de CSS e frontend
...
1. Mantenha o navegador aberto para ver atualizações ao vivo
2. Faça commit do código funcionando com frequência
